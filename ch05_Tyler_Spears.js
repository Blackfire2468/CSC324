...
let newArray = arrays.reduce((currentArray, next)=> currentArray.concat(next))
...
/*Everything
Arrays also have an every method analogous to the some method. This method returns 
...
function every(array, test) {
  return !array.some(part => !test(part));
}
