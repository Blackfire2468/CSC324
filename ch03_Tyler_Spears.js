...
function isEven(n) {
  let output = "";
    if (n % 2 == 0) output += "true";
  else if (n % 2 != 0) output += "false";
return output;
}
...
/*this is the only way i could figure out how to make this 
function work since we need both countBs and countchar to return the count*/
function countBs(str) {   
  return countChar(str);
}
/*if we were just doing countChar then you 
would only need this function*/
